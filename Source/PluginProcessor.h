...
/**
*/
class ZliMagFXDistortionAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    ZliMagFXDistortionAudioProcessor();
    ~ZliMagFXDistortionAudioProcessor() override;
    ...
    juce::AudioProcessorValueTreeState parametersTree {*this, nullptr, "Parameters", createParameterLayout()};
